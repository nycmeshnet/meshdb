...
class TestAdminChangeView(TestCase):
    ...
    def test_change_post_building(self):
        route = f"/admin/meshapi/building/{self.building_1.id}/change/"
        code = 200
