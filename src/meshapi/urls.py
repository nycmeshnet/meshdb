...
urlpatterns = [
    ...
    path("billing/installfeedata/", views.InstallFeeBillingDataList.as_view(), name="meshapi-v1-installfeedatum-list"),
    path(
        "billing/installfeedatum/<uuid:pk>/",
        views.InstallFeeBillingDataDetail.as_view(),
        name="meshapi-v1-installfeedataum-detail",
    ),
