...
urlpatterns = [
    ...
    path("loses/<int:pk>/", views.LOSDetail.as_view(), name="meshapi-v1-los-detail"),
    ...
    path("accesspoints/<int:pk>/", views.AccessPointDetail.as_view(), name="meshapi-v1-accesspoint-detail"),
